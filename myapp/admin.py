...
admin.site.register(Agriculture_Universities)
admin.site.register(Agriculture_News)
admin.site.register(Agriculture_Videos)
admin.site.register(Agriculture_Crop)
admin.site.register(Agriculture_Call_centre)
admin.site.register(Agriculture_Farmer_Scheme)
admin.site.register(Latest_Technology)
admin.site.register(Indian_Agriculture_University)
